...
<head>
    ...
    <title>Sysontime - Virtual Assistant</title>
    <!-- web-fonts -->
...
<section class="about-text ptb-100">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <p>sysontime Software provides professional virtual assistant services. We have skilled staff members who 
					can assist you in every aspect of your business, without any problems. We serve clients, including coaches, 
					realtors, consultants, solo entrepreneurs, small business owners and other professionals who are in need of 
					virtual assistants. We are available to serve you round the clock for any types of requirements. We will help 
					you save money while you work with us, as we are able to eliminate most office paraphernalia, such as office equipment,
					office space, maintenance costs and can reduce the need for employing more staff for management and administration.</p>
            </div>
            <div class="col-md-6">
                <p>We, as experienced virtual assistant professionals, also help you cut down other overhead costs, 
					for instance: insurance, employee-related taxes and other expenses. We will also reduce the need for materials spent on projects.
                    We try to understand the complete needs of our clients from every perspective. Our virtual assistants have diverse skills,
					many of which are needed in order to manage a virtual office.
                   We provide a customized solution to our clients according to individual expectations..</p>
            </div>
        </div>
    </div>
