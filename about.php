...
<head>
    ...
    <title>About Sysontime Software Pvt. Ltd.</title>
    <!-- web-fonts -->
...
<section class="about-text ptb-100">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-11">
                <p>We are leading website designers and developers who specialize in parallax and responsive website designing,
				website development and many online marketing solutions. 
				We have a full focus on delivering high end and quality strategic solutions. 
				Our staffs have the capability to bring integrated internet marketing solutions and other useful services 
				for both medium and small business across the world. In addition to that, we are also ready for the challenges in forms of measurable results,
				timely delivery and quality client expectations. </p>
