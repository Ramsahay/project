...
<head>
    ...
    <title>Sysontime -Website and App development</title>
    <!-- web-fonts -->
...
<div id="x-corp-carousel" class="carousel slide hero-slide hidden-xs" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="img/image-slide-1.jpg" alt="Hero Slide">
        ...
        <div class="item">
            <img src="img/image-slide-2.jpg" alt="...">
        ...
        <div class="item">
            <img src="img/image-slide-3.jpg" alt="...">
...
<section class="x-services ptb-100 gray-bg">
    ...
    <section class="section-title">
        <div class="container text-center">
			...
			<h6	>Sysontime offers diverse services to organizations across the globe.</h6><h6> We pride ourselves in creating innovative solutions and building learner-appropriate strategies, which stand tall on the strong base of technology and research.</h6>
        </div>
    </section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="thumbnail clearfix">
                    <a href="#"><img class="img-responsive" src="img/web-designing.jpg" alt="Image"></a>

                    <div class="caption">
                        <h3><a href="#">WEB DESIGNING </a></h3>

                        <p>Professional looking websites designs with intelligent user interface and unique layouts.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="thumbnail clearfix">
                    <a href="#"><img class="img-responsive" src="img/web-development.jpg" alt="Image"></a>

                    <div class="caption">
                        <h3><a href="#">WEB DEVELOPMENT</a></h3>

                        <p>The world is getting online and so are the ways to make a deliberate difference for their online presence.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="thumbnail clearfix">
                    <a href="#"><img class="img-responsive" src="img/digital-marketing.jpg" alt="Image"></a>

                    <div class="caption">
                        <h3><a href="#">DIGITAL MARKETING</a></h3>

                        <p>Digital marketing is the promotion of products or brands via one or more forms of electronic media.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="thumbnail clearfix">
                    <a href="#"><img class="img-responsive" src="img/mobile-app.jpg" alt="Image"></a>

                    <div class="caption">
                        <h3><a href="#">MOBILE APP DEVELOPEMENT</a></h3>

                        <p>Our team of experts ensures in-house solutions throughout every step of the app development process, from concept to design to bug testing to final polishing.</p>
                    </div>
                </div>
            </div>
			<div class="col-md-6">
                <div class="thumbnail clearfix">
                    <a href="#"><img class="img-responsive" src="img/eCommerce.jpg" alt="Image"></a>
			...
			<div class="col-md-6">
                <div class="thumbnail clearfix">
                    <a href="#"><img class="img-responsive" src="img/placmemet.jpg" alt="Image"></a>

                    <div class="caption">
                        <h3><a href="#">TRAINING & PLACEMENT</a></h3>

                        <p>Online courses developed by our panel of subject matter experts provide a range of readymade online courses for rapid consumption.</p>
                    </div>
                </div>
            </div>
        </div>
